        ...
        private string BuildQueryString(Position origin, Position destination, GmsDirectionTravelMode mode, string language)
        {
            StringBuilder strBuilder = new StringBuilder(
                string.Format(
                    ...
                    string.Format(CultureInfo.InvariantCulture, "{0},{1}", origin.Latitude, origin.Longitude),
                    string.Format(CultureInfo.InvariantCulture, "{0},{1}", destination.Latitude, destination.Longitude),
